...
const TopNav = () => {
    ...
    <div className='max-w-[1520] mx-auto flex justify-between items-center p-4 '>
        ...
        <div className='flex items-center'>
            ...
            <h1 className='text-2xl font-semibold sm:text-3xl lg:text-4xl px-2'>
                Musho<span className='font-bold'>Eats</span></h1>
                <div className='hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]'>
                    <p className='bg-orange-700 text-white rounded-full p-2 text-bold'>Free</p>
                    <p className='p-2 text-bold'>Delivery</p></div>
        </div>
         ...
         <Toggle className='bg-gray-200 flex items-center mt-10 w-[100px] sm:w-[100px] lg:w-[200px]' size={25} />
         <button className='bg-orange-700 text-white hidden md:flex items-center py-2 rounded-full'>
            ...
            : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-200' 
                ...
                <h2 className='text-2xl text-bold p-4'>Musho<span className='text-orange-700 font-bold'>Eats</span></h2>
                <nav>
